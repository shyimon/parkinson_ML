...
net = nn.NeuralNetwork(network_structure, eta=eta, loss_type="mae", l2_lambda=0.000001, algorithm="sgd", activation_type="sigmoid", eta_plus=1.2, eta_minus=0.5, mu=1.75, decay=0.9, weight_initialzer="def", momentum=0.9)
